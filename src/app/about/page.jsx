      ...
      <div className={styles.container}>
        ...
        <section className={styles.firstSection}>
          ...
          <p>
            ...
            offrant ainsi des ingrédients frais, savoureux et nutritifs. Parmi
            ces sélections, un fruit et un légume sont mis en vedette, vous
            invitant à explorer leurs saveurs uniques.
          </p>
        </section>
        <section className={styles.secondSection}>
          ...
          <p>
            ...
            éveillez votre créativité culinaire avec &quot;4 Saisons&quot;.
          </p>
        </section>
